...
```mermaid
graph TD
    subgraph P1["1. Motor de Base de Datos Espacial"]
        ED[Estructuras de Datos - B+ Tree / R-Tree]
        L3[Lógica III - Hashing / Big Data]
        AD2[Análisis y Diseño II - Clean Architecture]
        AL[Álgebra Lineal - Vectores y Métricas]
    end

    subgraph P2["2. Simulador Logístico y de Tráfico Urbano"]
        L2[Lógica II - Dijkstra / Grafos / Heaps]
        TPC[Probabilidad y Colas - Modelos M/M/c]
        ME[Métodos Estadísticos - A/B Testing]
        TP[Técnicas de Prog - Java OOP / Multithreading]
    end

    subgraph P3["3. Compilador de Lenguaje Matemático"]
        TL[Teoría de Lenguajes - Lexer / Parser / AST]
        CD[Cálculo Diferencial e Integral - Derivación / Cuadratura]
        EDM[Ecuaciones Dif y Numéricos - RK4 / Newton]
    end

    subgraph P4["4. Plataforma FinTech Empresarial"]
        AD1[Análisis y Diseño I - IEEE 830 / BPMN]
        AD2_2[Análisis y Diseño II - Hexagonal / SOLID / GoF]
        MD2[Discretas II - Criptografía RSA / Firmas]
        TP2[Técnicas de Prog - JUnit / REST API / Java]
    end
```
